...
Идеи, исправления и новые команды или syscall-модули приветствуются. Перед добавлением новой команды учитывайте существующий формат: Lua-файл из `programs/` должен возвращать таблицу с полями `name`, `desc` и функцией `run`.
